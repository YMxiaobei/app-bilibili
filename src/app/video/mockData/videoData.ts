let mockVideo: any = {
  ...
  share_count: 1000,
  duration: 539,
  introduction: "转自https://www.youtube.com/watch?v=8QTcNsQDvsU 视频转自youtube \n 喜欢的话 记得关注和转发哦~想说什么可以留言给我~ 网易云电台 新浪微博@：一日歌 QQ群：631562471",
  tags: [ "V家", "宅舞", "cosplay", "现场", "vocaloid", "Chinajoy" ],
  srcs: [
    {
      name: "超清",
      src: "/assets/video/spideMan.mp4"
    },
    {
      name: "高清",
      src: ""
